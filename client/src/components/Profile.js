  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      toast.promise(updatePromise, {
        ...
        success: <b>Credentials updated successfully...</b>,
          ...
          <form className="py-1" onSubmit={formik.handleSubmit}>
            <div className="profile flex justify-center py-4">
              <label htmlFor="profile">
                <img
                  src={apiData?.profile || file || profileImg}
                  alt="avatar"
            ...
            <div className="textbox flex flex-col gap-6 items-center">
              <div className="name flex w-3/4 gap-10">
                <input
                  className={`${styles.text_box} ${extend.textbox}`}
                  type="text"
            ...
            <div className="text-center py-4">
              <span>
                Come back later?{' '}
                <button className="text-red-500" onClick={logOutUser}>
                  Log out
                </button>
              </span>
            </div>
